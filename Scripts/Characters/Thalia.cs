...
//
// public class Thalia(string id) : Unit
// {
//     public override string Id { get; init; } = id;
//     public override string Name { get; init; } = "Thalia";
//     public override TargetSide Side { get; set; } = TargetSide.Ally;
//     public new List<Action> Actions { get; set; } = [];
//     public new List<Element> Resistances { get; set; } = [Element.Dark, Element.Ice];
...
//     [Export] private static readonly int InitialHp = 15;
